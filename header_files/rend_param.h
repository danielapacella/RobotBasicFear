 ...
 * The network widget
 */
class RendParam : public QWidget
{
    Q_OBJECT
...
public:
	...
	ParamDialog(QWidget *parent = NULL);
...
private:
	...
	void createActions();
        ...
        QAction *allfoldersAct;
        QAction *parseAct;
        QAction *loadandparseAct;
        QAction *verboseornotAct;

	private slots:

	void show_allfolders();
	void parsetxt();
	void loadandparsetxt();
	void verbose_or_not();
